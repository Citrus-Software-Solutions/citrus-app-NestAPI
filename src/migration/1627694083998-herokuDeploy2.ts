...
export class herokuDeploy21627694083998 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "job_offer" ("id" SERIAL NOT NULL, "title" character varying(100) NOT NULL, "dead_line" date NOT NULL, "special_requirements" character varying(700), "duration" double precision NOT NULL, "hourly_rate" double precision NOT NULL, "status" integer NOT NULL, "employerId" integer, "locationId" integer NOT NULL, "employee_id" integer, CONSTRAINT "REL_6b605692bee5d3104f73a16a34" UNIQUE ("locationId"), CONSTRAINT "REL_a5822e2fda33e39c5d12c291e3" UNIQUE ("employee_id"), CONSTRAINT "PK_5286026037ab5fb5acfcb7e1829" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
